...
begin
	...
	using Revise
	Pkg.add(path="..")
	Pkg.add(["PlutoUI", "MixedModelsSim", "MixedModels", "DataFrames","Plots", "StableRNGs"])
end
...
@bind ols Radio(["stratum" => "stratum", "simultaneous" => "simultaneous", "inflated_identity" => "inflated_identity"],"stratum")
